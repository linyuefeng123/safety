...
WEIGHTS_PATH = '/data/keras-inception-resnet-v2/inception_resnet_v2_weights_tf_dim_ordering_tf_kernels.h5'
WEIGHTS_PATH_NO_TOP = '/data/keras-inception-resnet-v2/inception_resnet_v2_weights_tf_dim_ordering_tf_kernels_notop.h5'
